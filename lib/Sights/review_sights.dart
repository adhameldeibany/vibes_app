...
class ReviewSights extends StatefulWidget {
  ReviewSights({required SightModel Sight, required bool Fav, ExtendedReviewModel? Myreview, String? id}){
    sight = Sight;
    fav = Fav;
    if (Myreview != null) {
      myreview = Myreview;
  ...
  @override
  State<ReviewSights> createState() => _ReviewSightsState();
}

class _ReviewSightsState extends State<ReviewSights> {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              InkWell(
                onTap: (){
                  String ids = FirebaseFirestore.instance.collection("sightsreviews").doc().id;
