...
class ReviewEvents extends StatefulWidget {
  ReviewEvents({required EventModel Event, required bool Fav, ExtendedReviewModel? Myreview, String? id}){
    event = Event;
    fav = Fav;
    if (Myreview != null) {
      myreview = Myreview;
  ...
  @override
  State<ReviewEvents> createState() => _ReviewEventsState();
}

class _ReviewEventsState extends State<ReviewEvents> {
